...
public class ListenUserRole {
     ...
     * @param joinPoint
     */
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.UserController.updateUser(*,String[]))")
     ...
     * @param joinPoint
     */
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.UserController.addUser(*,String[]))")
    ...
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.UserController.del(..))")
    ...
    /**********************角色处理begin***************************/
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.RoleController.addRole(*,String[]))")
    ...
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.RoleController.updateUser(*,String[]))")
    ...
    @Around("execution(com.boot.util.JsonUtil com.boot.controller.RoleController.del(..))")
