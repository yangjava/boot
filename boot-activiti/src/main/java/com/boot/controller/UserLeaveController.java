...
import com.boot.base.CurrentUser;
import com.boot.core.shiro.Principal;
import com.boot.entity.BaseTask;
import com.boot.entity.LeaveOpinion;
...
//            UserLeave userLeave = (UserLeave) variables.get("userLeave");
    ...
    @ResponseBody
    public String showTaskList(Model model, com.boot.entity.Task task, String page, String limit) {
        CurrentUser user = CommonUtil.getUser();
        ...
        List<com.boot.entity.Task> tasks = new ArrayList<>();
        Map<String, Object> map = new HashMap<>();
        com.boot.entity.Task taskEntity = null;
        ...
        for (Task task1 : taskList) {
            ...
            taskEntity = new com.boot.entity.Task(task1);
